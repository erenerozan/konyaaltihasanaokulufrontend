...
if (isset($_POST["submit"])) {
    ...
    $mail->Subject = "SİTE MESAJI -> $konu";
     
    # mail içeriğini değişkenden alıyorum.
    $mail->Body = "$email+$telefon+$mesaj"; 
...
<body>
    ...
    <section id="bizeulasin">
        <br>
        <div class="bizeulasin-sol">
            <div class="ic">
                <p>İletişim Formu</p>
                <form role="form" action="bizeulasin.php" method="POST">
                    <div class="sol">
                        <input type="textbox" name="isimsoyisim" placeholder="Adınız Soyadınız" />
                        <input type="textbox" name="email" placeholder="E-mail Adresiniz" />
                    </div>
                    <div class="sag">
                        <input type="textbox" name="telefon" placeholder="Telefon Numaranız" />
                        <input type="textbox" name="konu" placeholder="Konu" />
                    </div>
