...
<body>
    ...
    <section id="haberlerveetkinlikler">
        <!-- <div class="baslik">Haberler ve Etkinlikler</div> -->
        <?php
        $dene2 = new sinif();
        $dene2->setCumle("SELECT * FROM dishabercoklu GROUP BY dokuman_Basligi ORDER BY STR_TO_DATE(dokuman_Tarih ,'%d-%m-%Y') DESC");
        $dene2->listeleClientDisHaber(); ?>
    </section>
